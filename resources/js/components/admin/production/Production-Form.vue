          ...
          <table  class="table table-striped table-bordered align-middle">
              ...
              <tbody>
                <tr v-for="(value,index) in data" :key="index">
                  ...
                  <td class="p-0 text-center" width="10%">{{value.bread_out}}</td>
                  <td class="p-0 text-center" width="10%">{{value.charge_pc}}</td>
                  <td class="p-0 text-center" width="10%">{{value.remaining_pcs}}</td>
                  <td class="p-0 text-center" width="10%">{{value.sold_bread}}</td>
                  <td class="p-0 text-center" width="10%">{{value.sales}}</td>
                </tr>
...
export default {
      mounted(){
            axios.post('/get_specific_production',{
                  production_id:window.location.pathname.split('/')[4]
                  })
            .then(res=>{
